...
public class BuxomHalfDamageVariable extends DynamicVariable
{   // Custom Dynamic Variables are what you do if you need your card text to display a cool, changing number that the base game doesn't provide.
    ...
    {
        return (BuxomMod.getPwrAmt(AbstractDungeon.player, CommonPower.POWER_ID)/2) + card.damage;
    }
    ...
    {
        return (BuxomMod.getPwrAmt(AbstractDungeon.player, CommonPower.POWER_ID)/2) + card.baseDamage;
    }
