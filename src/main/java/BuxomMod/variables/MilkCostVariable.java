package BuxomMod.variables;

import BuxomMod.cards.AbstractDefaultCard;
...
public class MilkCostVariable extends DynamicVariable
{   // Custom Dynamic Variables are what you do if you need your card text to display a cool, changing number that the base game doesn't provide.
    ...
    {
        return ((AbstractDynamicCard)card).isMilkCostModified;
    }
    ...
    {
        return ((AbstractDynamicCard) card).milkCost;
    }
    ...
    {   
        return ((AbstractDynamicCard)card).baseMilkCost;
    }
    ...
    {               
       return ((AbstractDynamicCard)card).upgradedMilkCost;
    }
}