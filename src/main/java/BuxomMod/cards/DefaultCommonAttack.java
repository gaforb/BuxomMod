...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = BuxomMod.makeID(DefaultCommonAttack.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom( // The action managed queues all the actions a card should do.
                ...
                new DamageAction(m, new DamageInfo(p, damage, damageTypeForTurn),
                        ...
                        AbstractGameAction.AttackEffect.LIGHTNING)); // The animation the damage action uses to hit.
    }
