...
import BuxomMod.powers.TCupPower;

import static BuxomMod.DefaultMod.makeCardPath;

// public class ${NAME} extends AbstractDynamicCard
public class TCupBra extends AbstractDynamicCard {
    ...
    // TEXT DECLARATION
    public static final String ID = DefaultMod.makeID(TCupBra.class.getSimpleName());
    public static final String IMG = makeCardPath("TCupBra.png");// "public static final String IMG = makeCardPath("${NAME}.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p,
                new TCupPower(p, p, magicNumber), magicNumber));
    }
