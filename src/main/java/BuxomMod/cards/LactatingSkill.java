...
public class LactatingSkill extends AbstractDynamicCard {
    ...
    public static final String ID = BuxomMod.makeID(LactatingSkill.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public LactatingSkill() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
