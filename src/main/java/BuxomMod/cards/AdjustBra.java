...
public class AdjustBra extends AbstractDynamicCard {
    ...
    // TEXT DECLARATION
    public static final String ID = BuxomMod.makeID(AdjustBra.class.getSimpleName());
    ...
    public AdjustBra() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
