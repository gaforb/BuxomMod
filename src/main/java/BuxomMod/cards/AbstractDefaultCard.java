...
public abstract class AbstractDefaultCard extends CustomCard {
    ...
    public int milkCost;
    public int baseMilkCost;
    public boolean isMilkCostModified;
    public boolean upgradedMilkCost;
    ...
    public void displayUpgrades() { // Display the upgrade - when you click a card to upgrade it
        ...
        if (upgradedMilkCost) {
            milkCost = baseMilkCost;
            isMilkCostModified = true;
        }
    ...
    public void upgradeMilkCost(int amount) { // If we're upgrading (read: changing) the number. Note "upgrade" and NOT "upgraded" - 2 different things. One is a boolean, and then this one is what you will usually use - change the integer by how much you want to upgrade.
        baseMilkCost += amount; // Upgrade the number by the amount you provide in your card.
        milkCost = baseMilkCost; // Set the number to be equal to the base value.
        upgradedMilkCost = true; // Upgraded = true - which does what the above method does.
    }
}