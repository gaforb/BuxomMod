...
import LehmanaMod.cards.*;
import LehmanaMod.characters.TheDefault;
import LehmanaMod.events.IdentityCrisisEvent;
import LehmanaMod.potions.PlaceholderPotion;
import LehmanaMod.relics.BottledPlaceholderRelic;
import LehmanaMod.relics.DwarfBoobsRelic;
import LehmanaMod.relics.WashboardRelic;
import LehmanaMod.util.IDCheckDontTouchPls;
import LehmanaMod.util.TextureLoader;
import LehmanaMod.variables.DefaultCustomVariable;
import LehmanaMod.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("LehmanaMod") // ${project.artifactId}
