...
public class PlaceholderPotion extends CustomPotion {
    ...
    public static final String POTION_ID = LehmanaMod.DefaultMod.makeID("PlaceholderPotion");
    ...
    public void use(AbstractCreature target) {
        int removal = target.getPower("LehmanaMod:CommonPower").amount;
        removal--;
        if (target.hasPower("LehmanaMod:CommonPower")) {
            if (AbstractDungeon.getCurrRoom().phase == AbstractRoom.RoomPhase.COMBAT) {
                AbstractDungeon.actionManager.addToBottom(new ReducePowerAction(target, target, target.getPower("LehmanaMod:CommonPower"), removal));
        }
