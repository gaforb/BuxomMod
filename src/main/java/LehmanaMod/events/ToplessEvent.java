...
import static LehmanaMod.DefaultMod.makeEventPath;
            ...
            case 0: // While you are on screen number 0 (The starting screen)
                switch (i) {
                    case 0: // If you press button the first button (Button at index 0), in this case: Inspiration.
                        ...
                        AbstractRelic relicMetric = RelicLibrary.getRelic("ToplessArtifact").makeCopy();
                    ...
                    case 1: // If you press button the second button (Button at index 1), in this case: Denial
                        ...
                        AbstractDungeon.player.heal(35);// Lose max HP
                    ...
                    case 3: // If you press button the fourth button (Button at index 3), in this case: TOUCH
                        imageEventText.loadImage("LehmanaModResources/images/events/IdentityCrisisEvent2.png"); // Change the shown image
