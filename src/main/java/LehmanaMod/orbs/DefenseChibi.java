...
public class DefenseChibi extends CustomOrb {
    ...
    private static final int EVOKE_AMOUNT = 12;
    ...
    public DefenseChibi() {
        ...
        super(ORB_ID, orbString.NAME, PASSIVE_AMOUNT, EVOKE_AMOUNT, DESCRIPTIONS[1], DESCRIPTIONS[3], makeOrbPath("defense_chibi.png"));
