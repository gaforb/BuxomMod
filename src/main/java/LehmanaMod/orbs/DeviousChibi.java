...
import static LehmanaMod.DefaultMod.makeOrbPath;
...
public class DeviousChibi extends CustomOrb {
    ...
    public DeviousChibi() {
        ...
        super(ORB_ID, orbString.NAME, PASSIVE_AMOUNT, EVOKE_AMOUNT, DESCRIPTIONS[1], DESCRIPTIONS[3], makeOrbPath("devious_chibi.png"));
    ...
    public void onStartOfTurn() {// 1.At the start of your turn.
        AbstractDungeon.actionManager.addToBottom(// 2.This orb will have a flare effect
                ...
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player,
                        new CommonPower(AbstractDungeon.player, AbstractDungeon.player, passiveAmount), passiveAmount));
    }
