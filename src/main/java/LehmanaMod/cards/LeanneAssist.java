...
public class LeanneAssist extends CustomCard {
    ...
    // TEXT DECLARATION
    public static final String ID = DefaultMod.makeID(LeanneAssist.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("LeanneAssist.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (b != null) {
            AbstractDungeon.actionManager.addToBottom(
                    new ReducePowerAction(p, p, p.getPower("LehmanaMod:CommonPower"), 1));
            AbstractDungeon.actionManager.addToBottom(
