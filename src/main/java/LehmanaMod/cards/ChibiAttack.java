...
import LehmanaMod.orbs.AttackChibi;
...
public class ChibiAttack extends AbstractDynamicCard {
    ...
    public boolean canUse(AbstractPlayer p, AbstractMonster m) {
        ...
        if (p.getPower("LehmanaMod:CommonPower") != null && p.getPower("LehmanaMod:CommonPower").amount < 5) {
            canUse = false;
    ...
    public void use(final AbstractPlayer p, final AbstractMonster m) {
        AbstractPower b = p.getPower("LehmanaMod:CommonPower");
        if (b != null) {
