...
public boolean canUse(AbstractPlayer p, AbstractMonster m) {
    ...
    for (AbstractPower pow : p.powers) {
        if (p.getPower("LehmanaMod:CommonPower") != null) {
            if ((pow.ID.contains("KCupPower")) && (p.getPower("LehmanaMod:CommonPower").amount > 0)) {
                canUse = true;
            }
            if ((pow.ID.contains("MCupPower")) && (p.getPower("LehmanaMod:CommonPower").amount >= 5)) {
                canUse = true;
            }
            if ((pow.ID.contains("TCupPower")) && (p.getPower("LehmanaMod:CommonPower").amount >= 10)) {
                canUse = true;
            }
        }
    }
