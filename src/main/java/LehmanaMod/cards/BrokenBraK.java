...
import LehmanaMod.cards.BuxomStatus;
...
public class BrokenBraK extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(BrokenBraK.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("BrokenBraK.png");// "public static final String IMG = makeCardPath("${NAME}.png");
