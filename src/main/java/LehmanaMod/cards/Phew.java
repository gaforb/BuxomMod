...
import LehmanaMod.powers.ReliefPower;
...
public class Phew extends AbstractDynamicCard {
    ...
    public boolean canUse(AbstractPlayer p, AbstractMonster m) {
        ...
        if (p.hasPower("LehmanaMod:CommonPower") == true) {
            if (p.getPower("LehmanaMod:CommonPower").amount >= 1) {
                canUse = true;
            }
        }
        else canUse = false;
    ...
    /*public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
            new ReducePowerAction(p, p, p.getPower("LehmanaMod:CommonPower"), magicNumber));
